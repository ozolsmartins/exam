...
pygame.display.set_caption("Utility Stash")
...
FONT = pygame.font.Font("assets/Montserrat-Bold.ttf", 120)
...
START_STOP_BUTTON = Button(WHITE_BUTTON, (WIDTH/2, HEIGHT/2+100), 170, 60, "START", 
                    pygame.font.Font("assets/Montserrat-Bold.ttf", 20), "#4B4B4B", "#000000")
POMODORO_BUTTON = Button(None, (WIDTH/2-150, HEIGHT/2-140), 120, 30, "Pomodoro", 
                    pygame.font.Font("assets/Montserrat-Bold.ttf", 20), "#FFFFFF", "#4B4B4B")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if started:
                ...
                START_STOP_BUTTON.text = pygame.font.Font("assets/Montserrat-Bold.ttf", 20).render(
